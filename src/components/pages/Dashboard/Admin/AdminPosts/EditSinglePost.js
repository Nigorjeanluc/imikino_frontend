...
import { getSingle, editPostAdmin } from '../../../../../redux/actions/post';
...
class Frontpage2 extends Component {
  ...
  handleSubmit = (event) => {
    ...
    const { editPostAdmin, post } = this.props;
    const {
      image,
      title,
      socket,
    ...
    editPostAdmin(id, formData, formOptions);
  }
...
const mapDispatchToProps = (dispatch) => ({
  ...
  editPostAdmin: (id, data, options) => dispatch(editPostAdmin(id, data, options))
});
