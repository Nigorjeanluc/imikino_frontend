...
export default (state = topScorer, { type, payload }) => {
  switch (type) {
    case topScorerTypes.DELETE_TOP_SCORER_START:
      return {
        ...state,
        loading: true,
        getTopScorer: { ...state.getTopScorer, message: '', loading: true, errors: '' }
      };
    case topScorerTypes.DELETE_TOP_SCORER_SUCCESS:
      return {
        ...state,
    ...
    case topScorerTypes.DELETE_TOP_SCORER_END:
      return {
        ...state,
        getTopScorer: { ...state.getTopScorer }
      };
    case topScorerTypes.DELETE_TOP_SCORER_FAILURE:
      return {
        ...state,
        loading: false,
