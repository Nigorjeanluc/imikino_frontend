...
export default (state = location, { type, payload }) => {
  switch (type) {
    case locationTypes.CREATE_LOCATION_START:
      return {
        ...state,
        loading: true,
        getLocation: { ...state.getLocation, message: '', loading: true, errors: '' }
      };
    case locationTypes.CREATE_LOCATION_SUCCESS:
      return {
        ...state,
    ...
    case locationTypes.CREATE_LOCATION_END:
      return {
        ...state,
        getLocation: { ...state.getLocation }
      };
    case locationTypes.CREATE_LOCATION_FAILURE:
      return {
        ...state,
        loading: false,
