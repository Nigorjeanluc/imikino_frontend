...
const getFrontPageAllTables = ( league_id ,page = 1, limit = 10) => (dispatch) => dispatch(apiAction({
  method: 'get',
  httpOptions: { token: localStorage.token },
  url: `${BASIC_URL}/tables/${league_id}?page=${page}&limit=${limit}`,
...
export default getFrontPageAllTables;
